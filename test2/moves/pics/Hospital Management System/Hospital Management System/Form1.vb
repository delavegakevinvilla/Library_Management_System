...
#End Region
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        MsgBox("Product name: Hospital Management System" & vbNewLine & vbNewLine & "Version: 1.0" & vbNewLine & vbNewLine & "Copyright: 2018 CODERBABA" & vbNewLine & vbNewLine & "Developer: Balram Yadav" & vbNewLine & vbNewLine & "Description: Hospital Management System is a software application that is capable of managing a hospital's patients and their appointments. The user interface is simple and clean in order to achieve maximum efficiency.")
    End Sub
