...
Public Class bookmanagementt1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "test2.bookmanagementt1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedbookmanagementt1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As bookmanagementt1 = New bookmanagementt1()
        rpt.Site = Me.Site
        Return rpt
    End Function
